			...
			<div class="row">
				<div class="col-md-9 no-padding">
					<div class="wrap--outer">
						...
						<!-- Search Form -->
						<form accept-charset="utf-8" id="tfnewsearch" method="get" action="http://localhost/workstation/banlist.php">
							<div class="wrap--inner">
								<div class="wrap">
									<select name='division' size='20' class='list filterSelect' data-target='select-family' id='select-city'>
										...
										while($val=mysqli_fetch_assoc($res)){
											?>
											<option style="cursor:pointer"  class="pointOption" value="<?php echo $val['division']?>" data-reference="<?php echo $j++?>"><?php echo $val['division']?></option>
										<?php } ?>
									</select>
								</div>
