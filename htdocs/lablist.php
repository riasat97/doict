        ...
        <script type="text/javascript">
            $(document).ready(function($) {
                var table = $('#example ').DataTable({
                    ...
                    "order": [[ 0, 'asc' ]],
                    "processing": true,
                    "sAjaxSource":"labdata.php?division=<?php echo isset($_GET["division"])?$_GET["division"]:''; ?>&district=<?php echo isset($_GET["district"])?$_GET["district"]:'' ;?>&sub_district=<?php echo isset($_GET["sub_district"])?$_GET["sub_district"]:'' ;?>",
                    "pageLength": 25,
                    "dom": 'lBfrtip',
            ...
            <div class="row">
                <div class="col-md-12 no-padding">
                    <div class="wrap--outer">
                        ...
                        <p class="main-heading" style="font-size: 14px;">নির্বাচিত শিক্ষা প্রতিষ্ঠানের চূড়ান্ত তালিকা</p>
